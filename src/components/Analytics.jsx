    ...
    <div className='w-full bg-white py-16 px-4'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
         ...
         <div className='flex flex-col justify-center'>
            ...
            <p className=''>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Culpa eum possimus sequi, omnis ea delectus excepturi illum natus nulla dolor ab cupiditate quam quos sint adipisci laborum nesciunt! Laudantium, ut!
            </p>
