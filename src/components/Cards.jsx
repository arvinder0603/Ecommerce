...
const Cards = () => {
  return (
   ...
   <div className='w-full shadow-xl md:my-0 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
    <img className=' w-20 mx-auto mt-[-3rem] bg-gray ' src={double} alt='/'></img>
    ...
    <div className='text-center font-medium'>
        ...
        <p className='py-2 border-b mx-8 mt-8' >Send upto 4 GB</p>
    </div>
    <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto  py-3 text-black'>Start Trial</button>
   </div>
   <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
    <img className=' w-20 mx-auto mt-[-3rem] bg-white bg-transparent' src={triple} alt='/'></img>
    <h2 className='text-2xl font-bold text-center py-8'>family/group</h2>
    <p className='text-center text-4xl font-bold'>$500</p>
    <div className='text-center font-medium'>
        <p className='py-2 border-b mx-8 mt-8'>2500 GB Storage</p>
        <p className='py-2 border-b mx-8 mt-8'>5 Granted User</p>
        <p className='py-2 border-b mx-8 mt-8' >Send upto 4 GB</p>
    </div>
    <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto  py-3 text-black'>Start Trial</button>
   </div>
